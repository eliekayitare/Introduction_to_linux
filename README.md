...
Starting in ~/projects/client_work/web/frontend
	...
	1. To ~/projects/personal/experiments: `cd ../../../personal/experiments`
  	 Prove: `pwd` (output: /home/BUJULI/projects/personal/experiments)

	2. To ~/projects/shared/templates: `cd ../../shared/templates`
   	Prove: `pwd` (output: /home/BUJULI/projects/shared/templates)

	3. Back to start: `cd ../../client_work/web/frontend`
  	 Prove: `pwd` (output: /home/BUJULI/projects/client_work/web/frontend)
...
Create testuser: sudo useradd ntarindwa

groups groups ntarindwa
...
id (effective groups)
sudo useradd ntarindwa

 getent group ntarindwa

Change group: usermod -aG groupname ntarindwa (but requires logout for effect.)
su - ntarindwa
ls
id
 su - BUJULI
...
chmod g+s forensics/reg/file
 ...
 sudo chown BUJULI forensics/reg/file
