...
This readme contains the solutions for **Assignment 2** in the _Introduction to Linux_ course.
...
- Memorizing commands and debugging in case or situation where I'd make a typo or something similar.
- Writing complex `find` queries.
- Differentiating between variations in sudo commands.
